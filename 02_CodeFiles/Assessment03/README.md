...
-----------------------------------------------------------------------------------------------------------------------
 ...
 005             Exting the program                      Would be good                          Well 
-----------------------------------------------------------------------------------------------------------------------
````````````````````````````````````````
...
First of all, [the 1st task program](https://github.com/leehaesung/VisualBasic/blob/master/02_CodeFiles/Assessment02/README.md) helped me understand it easier. I manually wrote many DB tables on MS Access 2007 and then I codded [above the DB program](https://github.com/leehaesung/VisualBasic/blob/master/02_CodeFiles/Assessment03/OutputImageFiles/06_student.png) on Microsoft Visual Basic 2010 Express. I manually put the data on the Training DB System. So, It was automatically organized and sorted manual data in the DB Management program. Also, we could search the data anytime. In the future, I would code Search Program inside and would apply my web using jquery DB Server. Secondly, it is widly useful for data scientist to use huge DB data. So,I will be using DB programing for [my IoT Sensor device](https://github.com/leehaesung/A_Developer_Guide_To_the_IoT_IBM/blob/master/03_RaspberryPi2/ImageFiles/Raspberry-Pi-2-B.jpg). Indeed, It would be useful to efficiently organize huge IoT-sensor data.
